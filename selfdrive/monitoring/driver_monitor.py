...
if not EnableLogger:
  _AWARENESS_TIME = 36000.
else:
  _AWARENESS_TIME = 60. #35.  # one minute limit without user touching steering wheels make the car enter a terminal status
_AWARENESS_PRE_TIME_TILL_TERMINAL = 30. #  7.  # a first alert is issued 15s before expiration
_AWARENESS_PROMPT_TIME_TILL_TERMINAL = 30. #5.  # a second alert is issued 6s before start decelerating the car
